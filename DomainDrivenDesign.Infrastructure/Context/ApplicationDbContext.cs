...
public sealed class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            addressBuilder.Property(p => p.Country).HasColumnName("Country").HasColumnType("varchar(50)");

            addressBuilder.Property(p => p.City).HasColumnName("City").HasColumnType("varchar(50)");

            addressBuilder.Property(p => p.Town).HasColumnName("Town").HasColumnType("varchar(50)");

            addressBuilder.Property(p => p.Street).HasColumnName("Street").HasColumnType("varchar(50)");

            addressBuilder.Property(p => p.FullAddress).HasColumnName("FullAddress").HasColumnType("varchar(250)");
        });
    }
}
